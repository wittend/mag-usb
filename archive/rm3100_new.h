...
//-------------------------------------------
#define CMMMODE_START ((uint8_t)1)
#define CMMMODE_DRDM  ((uint8_t)4)     // Dont Use
#define CMMMODE_CMX   ((uint8_t)16)
#define CMMMODE_CMY   ((uint8_t)32)
#define CMMMODE_CMZ   ((uint8_t)64)

#define CMMMODE_ALL   ((uint8_t)(CMMMODE_START | CMMMODE_CMX | CMMMODE_CMY | CMMMODE_CMZ))

//-------------------------------------------
// Polled Measurement Mode
//-------------------------------------------
#define PMMODE_CMX   ((uint8_t)16)
#define PMMODE_CMY   ((uint8_t)32)
#define PMMODE_CMZ   ((uint8_t)64)
#define PMMODE_ALL   ((uint8_t)(PMMODE_CMX | PMMODE_CMY | PMMODE_CMZ))

//-------------------------------------------
// I2C bus speed options available
//-------------------------------------------
#define I2C_STANDARD    ((uint32_t)100000)
#define I2C_FASTMODE    ((uint32_t)1000000)
#define I2C_HIGHSPEED   ((uint32_t)3400000)

#define CCP0             ((uint8_t)0xC8)        // 200 Cycle Count
#define CCP1             ((uint8_t)0x00)
...
//-------------------------------------------
#define CC_50   ((uint32_t)0x32)        // 50  decimal
#define CC_100  ((uint32_t)0x64)       // 100 decimal
#define CC_200  ((uint32_t)0xC8)       // 200 decimal (default)
#define CC_300  ((uint32_t)0x12C)      // 300 decimal
#define CC_400  ((uint32_t)0x190)      // 400 decimal
#define CC_800  ((uint32_t)0x320)      // 800 decimal
...
//-------------------------------------------------------------------------------------------------
#define TMRC_VAL_600   ((uint8_t)0x92)
#define TMRC_VAL_300   ((uint8_t)0x93)
#define TMRC_VAL_150   ((uint8_t)0x94)
#define TMRC_VAL_75    ((uint8_t)0x95)
#define TMRC_VAL_37    ((uint8_t)0x96)
#define TMRC_VAL_18    ((uint8_t)0x97)
#define TMRC_VAL_9     ((uint8_t)0x98)
#define TMRC_VAL_4p5   ((uint8_t)0x99)
#define TMRC_VAL_2p3   ((uint8_t)0x9A)
#define TMRC_VAL_1p2   ((uint8_t)0x9B)
#define TMRC_VAL_0p6   ((uint8_t)0x9C)
#define TMRC_VAL_0p3   ((uint8_t)0x9D)
#define TMRC_VAL_0p15  ((uint8_t)0x9E)    // Time between readings: ~6.7 s
#define TMRC_VAL_0p07  ((uint8_t)0x9F)    // Time between readings: ~13 s
// Default rate 125 Hz
